...
//     int time_stamp=0;
//     //并发系统
//     static const int MAXtreeblocknum=1;
//     static const int MAXdatablocknum=1;
...
//     }
//     #endif
//     BPlusTree(std::string file_name,bool isnew=false):datafile(file_name+"_data"),treefile(file_name+"_tree"){
//         time_stamp=0;
//         treepos.clear();
//         datapos.clear();
...
//                 i++;
//             }
//             innernode_ptr tmp(nw->children[i],this);
//             // buffergettreefile(nw,nw->children[i]);
//         }
//         int i = 0;
//         while (i < nw->num-1 && lower_bound > nw->keys[i]) {
